...
urlpatterns = [
    ...
    path('poland-in-numbers/<int:field_id>/<int:field_variable_id>/<str:field_variable_name>/', views.poland_in_numbers_field_viewing, name='poland_in_numbers_field_viewing'),
